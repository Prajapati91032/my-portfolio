...
export default function SinglePost() {
    ...
    return (
        <main className="bg-gray-200 min-h-screen p-12">
            <article className="container shadow-lg mx-auto bg-green-100 rouned-lg">
                <header className="relative">
                    <div className="absolute h-full w-full flex items-center jsify-center p-8">
                ...
                <div className="px-16 lg:px-48 py-12 lg:py-2 prose lg:prose-xl max-w-full">
                    <BlockContent 
